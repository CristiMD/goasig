...
! function (t) {
  t.extend(t.fn, {
      ...
      messages: {
          ...
          remote: "Campul este necesa.",
          email: "Emailul nu este valid.",
          url: "Please enter a valid URL.",
          date: "Data nu este valida.",
          dateISO: "Data nu este valida (ISO).",
          ...
          rangelength: t.validator.format("Introduceti o valoare intre {0} si {1} caractere."),
          range: t.validator.format("Introduceti o valoare intre {0} si {1}."),
          max: t.validator.format("Introduceti o valoare mai mica sau egala cu {0}."),
          min: t.validator.format("Introduceti o valoare mai mare sau egala cu {0}."),
          numaiinm: "Numarul de inmatriculare nu este valid.",
          cnp: "CNP-ul nu este valid.",
          cui: "Numarul de inmatriculare nu este valid.",
          seriesasiu: "Seria de sasiu nu este valida.",
          serieciv: "Seria CIV nu este valida."
      },
      autoCreateRanges: !1,
      prototype: {
          init: function () {
      ...
      methods: {
          ...
          numaiinm: function (t, e) {
              return this.optional(e) || /^([a-zA-Z]{1,2}[0-9]{2,3}[a-zA-Z]{3})$/.test(t)
          },
          cnp: function (t, e) {
              return this.optional(e) || /^[1-9]\d{2}(0[1-9]|1[0-2])(0[1-9]|[12]\d|3[01])(0[1-9]|[1-4]\d|5[0-2]|99)(00[1-9]|0[1-9]\d|[1-9]\d\d)\d$/.test(t)
          },
          seriesasiu: function (t, e) {
              return this.optional(e) || /^([a-zA-Z0-9]{13,17})$/.test(t)
          },
          serieciv: function (t, e) {
              return this.optional(e) || /^([a-zA-Z]{1}[0-9]{6})$/.test(t)
          }
      }
